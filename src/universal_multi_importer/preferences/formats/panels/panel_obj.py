...
from ....ui.panel import draw_panel, draw_version_warning, draw_prop, draw_import_as_geometry_node_settings
    ...
    def draw(self, operator, module_name, layout):
        ...
        if module_name == "default":
            if BVERSION >= 4.1:
                ...
                op = [[operator, "import_vertex_groups"], [operator, "validate_meshes"]]

                draw_panel(layout, op, "OBJSettings_Options", "Options", icon="OPTIONS")

            elif BVERSION >= 3.3:
                op = [[operator, "clamp_size"], [operator, "forward_axis"], [operator, "up_axis"]]
                ...
                op = [[operator, "use_image_search"], [operator, "use_smooth_groups"], [operator, "use_edges"]]

                draw_panel(layout, op, "OBJSettings_Include", "Include", icon="IMPORT")

                op = [[operator, "global_clamp_size"], [operator, "axis_forward"], [operator, "axis_up"]]
