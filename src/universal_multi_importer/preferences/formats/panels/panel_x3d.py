...
from ....ui.panel import draw_panel, draw_version_warning, AddonVersion
    ...
    def draw(self, operator, module_name, layout):
        ...
        if BVERSION >= 4.2:
            ...
            if panel:
                ...
                draw_panel(
                    layout, op, "X3DSettings_Transform", "Transform", icon="OBJECT_DATA", panel=panel, header=header
                )
