...
class IMPORT_SCENE_XYZSettings:
    ...
    def draw(self, operator, module_name, layout):
        ...
        op = [[operator, "use_camera"], [operator, "use_lamp"], [operator, "use_center"], [operator, "use_center_all"]]
        ...
        op = [[operator, "scale_ballradius"], [operator, "scale_distances"], [operator, "atomradius"]]

        draw_panel(
            layout, op, "XYZSettings_BallsAtoms", "Balls / Atoms", icon="NODE_MATERIAL", panel=panel, header=header
        )

        op = [[operator, "skip_frames", "Skip Frames"], [operator, "images_per_key", "Frames/key"]]
