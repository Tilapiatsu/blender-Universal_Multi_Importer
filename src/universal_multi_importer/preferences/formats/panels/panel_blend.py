...
from ....ui.panel import draw_version_warning
...
class IMPORT_SCENE_BLENDSettings:
    ...
    def draw(self, operator, module_name, layout):
        ...
        if BVERSION >= 4.2:
            ...
            header.label(text="Import Data", icon="IMPORT")
            if panel:
                row = panel.row()
                ...
                # draw_import_data(col2, operator, 'Shape Keys', 'import_shape_keys', 'SHAPEKEY_DATA')
