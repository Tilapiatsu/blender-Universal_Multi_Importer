...
class IMPORT_SCENE_FBXSettings:
    ...
    def draw(self, operator, module_name, layout):
        ...
        if BVERSION >= 5.0:
            ##### General
            op = [[operator, "global_scale"], [operator, "use_custom_props"]]
            ...
            _, panel = draw_panel(
                layout,
                op,
                "FBXSettings_Animation",
                "Animation",
                set_header_boolean=True,
                header_bool=[operator, "use_anim"],
            )
            ...
            ##### Include
            op = [[operator, "use_custom_normals"], [operator, "use_subsurf"], [operator, "use_custom_props"]]
            ...
            if panel:
                ...
                op = [[operator, "use_image_search"], [operator, "colors_type"]]

                draw_panel(layout, op, "FBXSettings_Include", "Include", icon="IMPORT", panel=panel, header=header)

            #### Transform
            op = [[operator, "global_scale"], [operator, "decal_offset"]]
            ...
            #### Manual Orientation
            op = [[operator, "axis_forward"], [operator, "axis_up"]]

            draw_panel(
                layout,
                op,
                "FBXSettings_Transform_Manual_Orientation",
                "Manual Orientation",
                default_closed=True,
                set_header_boolean=True,
                header_bool=[operator, "use_manual_orientation"],
            )
            ...
            #### Armature
            header, panel = draw_panel(
                layout, op, "FBXSettings_Armature", "Armature", icon="ARMATURE_DATA", default_closed=True
            )
