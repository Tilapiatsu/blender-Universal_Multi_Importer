...
from ....ui.panel import draw_panel, draw_version_warning, draw_no_settings
...
class IMPORT_SCENE_USDSettings:
    ...
    def draw(self, operator, module_name, layout):
        ...
        if BVERSION >= 5.0:
            ...
            op = [[operator, "import_blendshapes"], [operator, "import_skeletons"]]

            draw_panel(layout, op, "USDSettings_Rigging", "Rigging", icon="BONE_DATA", default_closed=True)

            op = [
                [operator, "import_all_materials"],
            ...
            header, panel = draw_panel(
                layout, op, "USDSettings_Textures", "Textures", icon="TEXTURE", default_closed=True
            )
            ...
            draw_panel(
                layout,
                op,
                "USDSettings_ParticlesAndInstancing",
            ...
            op = [[operator, "import_render"], [operator, "import_proxy"], [operator, "import_guide"]]
            ...
            op = [[operator, "read_mesh_uvs"], [operator, "read_mesh_colors"]]
            ...
            op = [[operator, "set_frame_range"], [operator, "relative_path"], [operator, "light_intensity_scale"]]
