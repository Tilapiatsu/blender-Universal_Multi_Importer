...
class IMPORT_SCENE_IMAGESettings:
    ...
    def draw(self, operator, module_name, layout):
        ...
        if module_name == "plane":
            if BVERSION >= 5.0:
                op = [[operator, "relative"], [operator, "force_reload"], [operator, "image_sequence"]]
                ...
                op = [[operator, "interpolation"], [operator, "extension"], [operator, "use_transparency"]]

                header, panel = draw_panel(
                    layout, op, "IMAGESettings_TextureSettings", "Texture Settings", icon="TEXTURE"
                )
            ...
            op = [[operator, "relative_path"], [operator, "use_sequence_detection"], [operator, "use_udim_detecting"]]
            ...
            if BVERSION >= 4.3:
                ...
                op = [[operator, "align"], [operator, "background"]]
            ...
            if BVERSION >= 4.2:
                op = [[operator, "align"], [operator, "location"], [operator, "rotation"], [operator, "background"]]
