...
class IMPORT_SCENE_PDBSettings:
    ...
    def draw(self, operator, module_name, layout):
        ...
        op = [[operator, "use_camera"], [operator, "use_light"], [operator, "use_center"]]
        ...
        draw_panel(
            layout, op, "PDBSettings_BallsAtoms", "Balls /  Atoms", icon="NODE_MATERIAL", panel=panel, header=header
        )
        ...
        _, panel = draw_panel(
            ...
            header_bool=[operator, "use_sticks"],
        )
