...
### v2.2.0 : Support for webp format, and audio format
### v2.2.0 : Command Batcher now have 3 lists : Pre-process which will be executed ONCE at the begining, Each-Process, which will be execture for each Object / Imported file, and Post-Process which will be exectued ONCE at the end of the process
