...
class FormatDefinition():
    ...
    if BVERSION >= 4.3:
        ...
        x3d = {'name' : 'x3d',
            'ext' : ['.x3d', '.wrl'],
            'operator' : {'default':{'command':'bpy.ops.import_scene.x3d','module' : None, 'addon_name' : 'io_scene_x3d', 'pkg_id' : None, 'pkg_url':None, 'import_settings':None, 'supported_version':'2.3.1'}},
            'ignore': ['files', 'directory'],
            'generate_filter_glob':True}

        gltf = {'name' : 'gltf',
            'ext' : ['.glb', '.gltf'],
            'operator' : {'default':{'command':'bpy.ops.import_scene.gltf','module' : None, 'addon_name' : 'io_scene_gltf2', 'pkg_id' : None, 'pkg_url':None, 'import_settings':None, 'supported_version':'3.6.28'}},
            'ignore': ['files', 'directory'],
            'generate_filter_glob':False}

        fbx = {'name' : 'fbx',
            'ext' : ['.fbx'],
            'operator' : {'default':{'command': 'bpy.ops.import_scene.fbx', 'module' : None, 'addon_name' : 'io_scene_fbx', 'pkg_id' : None, 'pkg_url':None, 'import_settings':None, 'supported_version':'5.4.1'}},
            'ignore': ['files', 'directory'],
            'generate_filter_glob':False}
        ...
        'ext' : [	'.jpg', '.jpeg', '.gif', '.png', '.tif', '.tiff', '.bmp', '.cin', '.dpx', '.jp2', '.j2c', '.sig', '.rgb', '.bw',
                    '.hdr', '.exr',
                    '.mov', '.mp4', '.mkv', '.mpg', '.mpeg', '.dvd', '.vob', '.avi', '.dv', '.flv', '.webm'],
        'operator' : {  'plane':{'command':'bpy.ops.import_image.to_plane', 'module':None, 'addon_name' : 'io_import_images_as_planes', 'pkg_id' : None, 'pkg_url':None, 'import_settings':None, 'supported_version':'3.5.0'},
                        'data':{'command':'bpy.ops.image.open', 'module':None, 'addon_name' : None, 'pkg_id' : None , 'import_settings':None, 'pkg_url':None, 'supported_version':'0.0.0'},
                        'ref':{'command':'bpy.ops.object.load_reference_image', 'module':None, 'addon_name' : None, 'pkg_id' : None, 'pkg_url':None, 'import_settings':None, 'supported_version':'0.0.0'},
                        'background':{'command':'bpy.ops.object.load_background_image', 'module':None, 'addon_name' : None, 'pkg_id' : None, 'pkg_url':None, 'import_settings':None, 'supported_version':'0.0.0'}},
        'ignore': ['files', 'directory', 'filepath'],
